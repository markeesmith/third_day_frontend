      ...
      <AboutStyles isMobile={isMobile}>
        <div className="AboutBlock">
          ...
          <p>
            ...
            with clients in order to bring detail and quality work to achieve
            the ultimate home for clients. His work is well known for quality
            and honesty. He has experience with custom home building, remodeling
        ...
        <div className="AboutBlock">
          ...
          <p>
            ...
            opportunity to work one-on-one with a contractor who has over 30
            years of experience building custom homes. This one-on-one
            communication allows for customers to directly communicate their
            needs and wishes to build the home or project they envision. This
            eliminates the frustration and time wasted trying to communicate
            wishes through a chain of employees. We guarantee to be with you
            every step of the way during this very important process.
          </p>
        </div>
        ...
        <div className="AboutBlock">
          ...
          <ul>
            ...
            <li>
              ...
              everything is settled, we provide a timeline for when the new
              home, addition, or remodel will be finished.
            </li>
            <li>
              <span className="ListName">Continued Communication: </span>While
              building the project, the builder will continue to communicate
              with the client. Any concerns, alterations, or further actions can
              be discussed.
            </li>
            <li>
